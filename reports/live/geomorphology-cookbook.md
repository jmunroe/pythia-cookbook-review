...
| Time to a ready session | 7m 56s (fresh build) |
| Build succeeded | yes |
| Notebook execution | 2m 22s |
...
| [`notebooks/Polygonization.ipynb`](https://github.com/ProjectPythia/geomorphology-cookbook/blob/main/notebooks/Polygonization.ipynb) | 10s |
| [`notebooks/rasterviz-intro.ipynb`](https://github.com/ProjectPythia/geomorphology-cookbook/blob/main/notebooks/rasterviz-intro.ipynb) | 16s |
| [`notebooks/jupytergis-showcase.ipynb`](https://github.com/ProjectPythia/geomorphology-cookbook/blob/main/notebooks/jupytergis-showcase.ipynb) | 45s |
| [`notebooks/Topographic-Positioning-Index-Methods.ipynb`](https://github.com/ProjectPythia/geomorphology-cookbook/blob/main/notebooks/Topographic-Positioning-Index-Methods.ipynb) | 53s |
