...
Live outcome: **ran clean**. [← All live checks](../live.md) · [Repository](https://github.com/ProjectPythia/healpix-cookbook)

Run 2026-07-22 05:17:25 UTC against [https://binder.projectpythia.org](https://binder.projectpythia.org), building [healpix-cookbook](https://github.com/ProjectPythia/healpix-cookbook) at ref [`main`](https://github.com/ProjectPythia/healpix-cookbook/tree/main).

:::{warning} Cached image
BinderHub reused an existing image, so the 11.11s is a pod launch and image pull. It does **not** test whether `environment.yml` still solves.
:::
...
| Peak memory (pss) | 1.83 GB |
| Pod memory limit | 8.59 GB |
| Peak as share of limit | 21.3% |
| Peak rss (upper bound, shared pages double-counted) | 2.04 GB |
| Errors raised | 0 |
