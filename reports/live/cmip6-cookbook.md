...
Live outcome: **execution failed**. [← All live checks](../live.md) · [Repository](https://github.com/ProjectPythia/cmip6-cookbook)

Run 2026-07-22 03:49:01 UTC against [https://binder.projectpythia.org](https://binder.projectpythia.org), building [cmip6-cookbook](https://github.com/ProjectPythia/cmip6-cookbook) at ref [`main`](https://github.com/ProjectPythia/cmip6-cookbook/tree/main).
...
| Peak memory (pss) | 7.32 GB |
| Pod memory limit | 8.59 GB |
| Peak as share of limit | 85.2% |
| Peak rss (upper bound, shared pages double-counted) | 8.81 GB |
| Errors raised | 0 |
