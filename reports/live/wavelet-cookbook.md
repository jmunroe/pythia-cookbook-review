...
Live outcome: **ran clean**. [← All live checks](../live.md) · [Repository](https://github.com/ProjectPythia/wavelet-cookbook)

Run 2026-07-22 08:07:15 UTC against [https://binder.projectpythia.org](https://binder.projectpythia.org), building [wavelet-cookbook](https://github.com/ProjectPythia/wavelet-cookbook) at ref [`main`](https://github.com/ProjectPythia/wavelet-cookbook/tree/main).
...
| Peak memory (pss) | 1.77 GB |
| Pod memory limit | 8.59 GB |
| Peak as share of limit | 20.6% |
| Peak rss (upper bound, shared pages double-counted) | 1.92 GB |
| Errors raised | 0 |
