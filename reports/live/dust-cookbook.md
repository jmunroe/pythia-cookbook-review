...
Live outcome: **ran clean**. [← All live checks](../live.md) · [Repository](https://github.com/ProjectPythia/dust-cookbook)

Run 2026-07-22 09:38:00 UTC against [https://binder.projectpythia.org](https://binder.projectpythia.org), building [dust-cookbook](https://github.com/ProjectPythia/dust-cookbook) at ref [`main`](https://github.com/ProjectPythia/dust-cookbook/tree/main).
...
| Peak memory (pss) | 1.00 GB |
| Pod memory limit | 8.59 GB |
| Peak as share of limit | 11.6% |
| Peak rss (upper bound, shared pages double-counted) | 1.19 GB |
| Errors raised | 0 |
