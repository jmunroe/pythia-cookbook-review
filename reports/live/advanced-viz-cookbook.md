...
Live outcome: **ran clean**. [← All live checks](../live.md) · [Repository](https://github.com/ProjectPythia/advanced-viz-cookbook)

Run 2026-07-22 03:28:40 UTC against [https://binder.projectpythia.org](https://binder.projectpythia.org), building [advanced-viz-cookbook](https://github.com/ProjectPythia/advanced-viz-cookbook) at ref [`main`](https://github.com/ProjectPythia/advanced-viz-cookbook/tree/main).
...
| Peak memory (pss) | 1.52 GB |
| Pod memory limit | 8.59 GB |
| Peak as share of limit | 17.8% |
| Peak rss (upper bound, shared pages double-counted) | 1.94 GB |
| Errors raised | 0 |
