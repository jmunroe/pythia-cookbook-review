# healpix-cookbook — Recommendations

Live outcome: **ran clean**. [← All recommendations](../recommendations.md) · [Live check](../reports/live/healpix-cookbook.md) · [Repository](https://github.com/ProjectPythia/healpix-cookbook)
...
This cookbook is in good shape: conda-forge only, no pip, no version pins, no Sphinx cruft, no
template links. DOI, release, ORCID (five authors), citation, license, thumbnail and real tags are
all present, and all five notebooks ran clean on Binder in ~82 s at 21% of the memory limit. There
is one small item.
...
- **Metadata is complete** — DOI, release `v2026.03.30`, ORCID, citation, license, thumbnail, real
  tags, five authors (static audit).
- **The notebooks carry standard `python3` kernelspecs** (scanned all five `*.ipynb`) — no latent
  execution time-bomb.
- **The live check ran clean** — build and execution both exit 0, five toc notebooks, peak 1.83 GB
  (21% of the 8.6 GB limit); 2026-07-22 snapshot.
